        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-fade-in">
              Stop Losing 30% of Your Logistics Budget to{" "}
              <span className="text-accent">Overhead and Poor Negotiations</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 opacity-90 animate-fade-in delay-100">
              Janio's 4PL platform gives you access to 500+ vetted 3PLs across Asia Pacific through one integration, one contract, one relationship. Join Disney, GOAT, and Swarovski in cutting logistics costs 20-50% while scaling faster.
            </p>
