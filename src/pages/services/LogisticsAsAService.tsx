        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-4xl lg:text-6xl font-bold font-display mb-6 animate-fade-in">
              Logistics as a Service: Your Complete 4PL Solution
            </h1>
            <p className="text-xl lg:text-2xl text-white/90 mb-8 leading-relaxed animate-slide-up">
              Transform your logistics from operational burden to strategic advantage 
              with our comprehensive LaaS platform covering all transportation modes and warehousing.
            </p>
