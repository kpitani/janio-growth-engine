        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold font-display text-foreground mb-6">
              Strategic Transportation Procurement That <span className="text-primary">Delivers Results</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Leverage our market expertise and proven negotiation strategies to optimize freight spend across Land, Air, and Ocean transportation.
            </p>
