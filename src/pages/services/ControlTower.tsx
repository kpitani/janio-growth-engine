        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold font-display text-foreground mb-6">
              Supply Chain Control Tower: <span className="text-primary">Command Your Entire Network</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Achieve real-time visibility, proactive control, and predictive optimization across your entire supply chain with AI-powered intelligence.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" size="xl" asChild>
                <Link to="/calculator/control-tower-roi">Calculate ROI</Link>
              </Button>
            </div>
          </div>
        </div>
