        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-fade-in">
              ...
              <span className="text-accent">Without Buying Assets</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 opacity-90 animate-fade-in delay-100">
              Offer your clients access to 500+ 3PLs across Asia Pacific under your brand. Generate new revenue streams, retain more clients, and compete with larger players—all through our white-label 4PL platform.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 mb-8">
              ...
              <ul className="grid md:grid-cols-2 gap-4 text-left">
                <li className="flex items-center gap-2">
                  ...
                  <span>500+ vetted providers across Asia Pacific</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-accent" />
                  <span>White-label technology platform</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-accent" />
                  <span>Operations support and expert management</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-accent" />
                  <span>Revenue generation from day one</span>
                </li>
              </ul>
            </div>
